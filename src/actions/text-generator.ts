...
import { fallbackKeywords, fallbackSubreddits } from "@/lib/constants/constants";
...
export const suggestSubreddits = async (
    ...
    try {
      ...
      return { status: 201, error: "No subreddits generated" , data:fallbackSubreddits(industry) };
    } catch (err) {
